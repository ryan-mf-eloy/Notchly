...
final class RealtimeQuestionAnsweringFlowTests: XCTestCase {
    ...
    func testQuestionAnswerHarnessExposesTranscriptInlineActions() {
        ...
        XCTAssertGreaterThanOrEqual(copyButton.frame.width, 20)
        XCTAssertGreaterThanOrEqual(copyButton.frame.height, 20)
        XCTAssertGreaterThanOrEqual(deleteButton.frame.width, 20)
        XCTAssertGreaterThanOrEqual(deleteButton.frame.height, 20)
        XCTAssertLessThanOrEqual(copyButton.frame.width, 28)
        XCTAssertLessThanOrEqual(copyButton.frame.height, 28)
        XCTAssertLessThanOrEqual(deleteButton.frame.width, 28)
        XCTAssertLessThanOrEqual(deleteButton.frame.height, 28)
